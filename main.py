...
def get_market_operations_tax_list(operation_list: list[dict]) -> list[dict]:
    """
    #TODO document this function as the main orchestrator
    ...
    for operation in operation_list[1:]:
        ...
        if operation["operation"] == "sell":
            ...
            current_position["cur_qty_shares"] = (
        ...
        operation_share_qty = int(operation["quantity"] / operation["unit-cost"])
        current_position["cur_avg_weighted"] = calculate_weighted_avg(
            ...
            buy_share_qty=operation_share_qty,
            buy_share_value=operation["unit-cost"],
        )

        current_position["cur_avg_weighted"] = current_position["cur_avg_weighted"]
        current_position["cur_qty_shares"] = (
            operation_share_qty + current_position["cur_qty_shares"]
        )

    return operations_tax_list
...
if __name__ == "__main__":
    ...
    print(json.dumps(output, default=decimal_default))
