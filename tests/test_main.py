...
def test_buy_then_sell_below_threshold():
    ...
    operations = [
        ...
        {"operation": "sell", "unit-cost": 15.00, "quantity": 10}  # 150 < 20k threshold
    ]
    result = json.loads(get_market_operations_tax_list(operations))
...
def test_buy_then_sell_above_threshold_with_profit():
    ...
    operations = [
        ...
        {"operation": "sell", "unit-cost": 20.00, "quantity": 2000}  # 20,000 = threshold
    ]
    result = json.loads(get_market_operations_tax_list(operations))
...
def test_multiple_operations_with_loss():
    ...
    operations = [
        ...
        {"operation": "sell", "unit-cost": 40.00, "quantity": 50},  # 2,000 < threshold, loss
...
def test_large_sell_with_previous_loss():
    ...
    operations = [
        ...
        {"operation": "sell", "unit-cost": 20.00, "quantity": 500},  # 10,000 < threshold, loss
        {"operation": "sell", "unit-cost": 40.00, "quantity": 500}   # 20,000 = threshold
    ]
    result = json.loads(get_market_operations_tax_list(operations))
...
def test_multiple_buys_before_sell():
    ...
    operations = [
        ...
        {"operation": "sell", "unit-cost": 25.00, "quantity": 15000}  # 3,750 < threshold
    ]
    result = json.loads(get_market_operations_tax_list(operations))
...
def test_large_operation_with_fractional_profit():
    ...
    operations = [
        ...
        {"operation": "sell", "unit-cost": 20.123, "quantity": 1000}  # 20,123 > threshold
    ]
    result = json.loads(get_market_operations_tax_list(operations))
